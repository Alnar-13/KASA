      ...
      <NavStyled>
        ...
        <UlStyled>
          <NavLink
            to="/"
            className={(
              { isActive } // la propriété isActive indique si l'utilisateur intéragit avec la page
            ) => (isActive ? 'active-link' : 'non-active-link ')} // si l'utilisateur est sur la page on donne la class active-link
          >
            <LiStyled>Accueil</LiStyled>
          </NavLink>
          <NavLink
            to="/about"
            className={({ isActive }) =>
